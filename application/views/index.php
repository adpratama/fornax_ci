...
<head>
	...
	<!-- Favicon -->
	<link href="<?= base_url() ?>assets/landing/img/favicon.ico" rel="icon">
...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
		<a href="index.html" class="navbar-brand ps-5 me-0">
			<h1 class="text-white m-0">Bandes Group</h1>
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<a href="<?= base_url('auth') ?>" class="btn btn-primary px-3 d-none d-lg-block">Login</a>
		</div>
	</nav>
	<!-- Navbar End -->
				...
				<div class="col-lg-6">
					<div class="row gx-3 h-100">
						<div class="col-6 align-self-start wow fadeInUp" data-wow-delay="0.1s">
							<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/about-1.jpg">
						</div>
						<div class="col-6 align-self-end wow fadeInDown" data-wow-delay="0.1s">
							<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/about-2.jpg">
						</div>
					</div>
				</div>
			...
			<div class="row g-5 align-items-center">
				<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
					<div class="position-relative me-lg-4">
						<img class="img-fluid w-100" src="<?= base_url() ?>assets/landing/img/feature.jpg" alt="">
			...
			<div class="row gy-5 gx-4">
				<div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
					<div class="service-item">
						<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/service-1.jpg" alt="">
				...
				<div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
					<div class="service-item">
						<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/service-2.jpg" alt="">
						<div class="service-img">
							<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/service-2.jpg" alt="">
						</div>
						<div class="service-detail">
				...
				<div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
					<div class="service-item">
						<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/service-3.jpg" alt="">
						<div class="service-img">
							<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/service-3.jpg" alt="">
						</div>
						<div class="service-detail">
	...
	<div class="container-fluid bg-dark pt-5 my-5 px-0">
		...
		<div class="owl-carousel project-carousel wow fadeIn" data-wow-delay="0.1s">
			...
			<a class="project-item" href="">
				<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/project-5.jpg" alt="">
				<div class="project-title">
					<h5 class="text-primary mb-0">Energy Engineering</h5>
				</div>
			</a>
			<a class="project-item" href="">
				<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/project-6.jpg" alt="">
				<div class="project-title">
		...
		<div class="container">
			...
			<div class="row g-4">
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
					<div class="team-item">
						<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/team-1.jpg" alt="">
						<div class="d-flex">
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
					<div class="team-item">
						<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/team-2.jpg" alt="">
						<div class="d-flex">
							<div class="flex-shrink-0 btn-square bg-primary" style="width: 90px; height: 90px;">
								<i class="fa fa-2x fa-share text-white"></i>
							</div>
				...
				<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
					<div class="team-item">
						<img class="img-fluid" src="<?= base_url() ?>assets/landing/img/team-3.jpg" alt="">
						<div class="d-flex">
							<div class="flex-shrink-0 btn-square bg-primary" style="width: 90px; height: 90px;">
								<i class="fa fa-2x fa-share text-white"></i>
							</div>
			...
			<div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
				<div class="testimonial-item text-center">
					<div class="testimonial-img position-relative">
						<img class="img-fluid rounded-circle mx-auto mb-5" src="<?= base_url() ?>assets/landing/img/testimonial-1.jpg">
				...
				<div class="testimonial-item text-center">
					<div class="testimonial-img position-relative">
						<img class="img-fluid rounded-circle mx-auto mb-5" src="<?= base_url() ?>assets/landing/img/testimonial-2.jpg">
						<div class="btn-square bg-primary rounded-circle">
							<i class="fa fa-quote-left text-white"></i>
						</div>
					</div>
				...
				<div class="testimonial-item text-center">
					<div class="testimonial-img position-relative">
						<img class="img-fluid rounded-circle mx-auto mb-5" src="<?= base_url() ?>assets/landing/img/testimonial-3.jpg">
						<div class="btn-square bg-primary rounded-circle">
							<i class="fa fa-quote-left text-white"></i>
						</div>
					</div>
