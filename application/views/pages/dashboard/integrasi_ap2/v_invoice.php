                        ...
                        <div class="mb-xl-0 mb-4">
                            <div class="d-flex svg-illustration mb-3 gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="<?= base_url() ?>assets/img/logo_bdl.png" alt="" class="w-px-60 p-2 h-auto bg-dark">
                                </span>
                                <span class="app-brand-text demo text-body fw-bold">Bangun Desa Logistindo</span>
                            </div>
