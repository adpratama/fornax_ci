<!-- / Navbar -->
<header class="header fixed-top d-flex align-items-center" style="top: 0">
    <div class="d-flex justify-content-between align-items-center">
        <a href="index.html" class="logo d-flex align-items-center">
            <img src="" alt="">
            <!-- <h3 class="d-none d-lg-block m-0">Fornax</h3> -->
        </a>
        <a href="#" class="burger-btn d-block ms-3">
            <i class="bi bi-justify"></i>
        </a>
        <div class="theme-toggle d-flex gap-2 align-items-center ms-3">
    ...
    <nav class="header-nav ms-auto" id="layout-navbar">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                        <div class="avatar avatar-online">
                            <img src="<?= base_url() ?>assets/dashboard/compiled/jpg/1.jpg" alt class="w-px-40 h-auto rounded-circle" />
                        </div>
                    </a>
